...
exports.index = function(req, res) {
  models.Course.findAll().then(
    function(course) {
	  ...
	  res.render('course', { course: [], errors: error});
  });
};
...
exports.show = function(req, res) {
	...
	models.Course.findAll().then(function(courses) {
		res.render('course/allcourses.ejs', { course: courses,action:action,editedCourse:editedCourse, errors: errors});
    }).catch(function(error) { 
    	res.render('course/allcourses.ejs', { course: {},action:"",editedCourse:"", errors: errors});
  });
}
...
exports.new = function(req, res) { 
	...
	res.render('course/new', {course: course,newCourse: newCourse});
};
...
exports.edit = function(req, res) {
  res.render('course/edit', {course: req.course, errors: []});
};
